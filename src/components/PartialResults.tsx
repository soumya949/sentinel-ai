...
const PartialResults = ({ answers, onViewBasic }: PartialResultsProps) => {
    ...
    <section className="py-20 bg-background min-h-[80vh] flex items-center">
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <motion.div
          ...
          className="bg-card border border-border rounded-2xl p-8 shadow-lg text-center mb-8"
        >
        ...
        >
          {["Detailed Risk Breakdown", "Critical Vulnerabilities", "Compliance Gaps"].map((title) => (
            <div key={title} className="relative rounded-2xl border border-border overflow-hidden">
              <div className="blur-sm p-6 bg-card/50">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-foreground mb-2">
            Your basic AI audit summary is ready.
          </h3>
          <p className="text-muted-foreground mb-6">
            View your basic report to see risk insights and recommendations based on your responses.
          </p>
